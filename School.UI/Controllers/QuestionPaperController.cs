...
namespace School.UI.Controllers
{
    ...
    {
        string Filelocation = System.Configuration.ConfigurationManager.AppSettings["questionPapers.DownloadFolder"];
        private IBooksRepository gradesRepository;
        public QuestionPaperController(IBooksRepository gradesRepository)
        {
